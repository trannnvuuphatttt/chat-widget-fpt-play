<template>
  <div class="">
    ...
    >
      ...
      >
        <div
          class="bg-white rounded-lg p-4 w-[90%] sm:w-[368px] h-fit m-4 flex flex-col gap-2"
        >
  ...
  >
    ...
    >
      <img
        ...
        class="w-[90%] sm:w-[12px] h-[90%] sm:h-[12px]"
      />
    </button>
    <div
      class="flex-none w-[90%] sm:w-[352px] h-auto gap-[16px] flex flex-col items-center"
    >
      <img
        src="/assets/images/avatar.png"
        class="w-[90%] h-[90%] sm:w-[104px] sm:h-[104px] text-center flex-none"
      />
      <p
        class="font-sf-pro-display text-[16px] text-center flex-auto leading-[20.8px] tracking-custom font-normal"
      >
