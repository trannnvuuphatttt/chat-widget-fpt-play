<template>
  <div class="">
    <div class="bg-white z-40 fixed widget-container rounded-lg flex flex-col overflow-hidden shadow-lg 
             w-[90%] sm:w-[400px] h-[90%] sm:h-[668px] 
                right-[5%] sm:right-[40px] bottom-[5%] sm:bottom-[40px]  "
  ...
  <div v-show="!modalStore.showWidget"
    ...
    <div id="box"
      class="hidden break-words bg-white leading-5 rounded-t-2xl p-4 z-50 shadow-lg animate__animated w-full h-[90%] sm:h-[74px]">
      <p id="typing-text" class="text-[90%] sm:text-[16px]"></p>
    </div>
    <button @click="modalStore.toggleWidget" class="z-40">
      <img src="/assets/images/avatar.png" class=" w-[40px] sm:w-[80px]  h-[40px] sm:h-[80px] " />
    </button>
  </div>
  <div
    class="widget-container bg-white rounded-[16px] shadow-lg w-[90%] sm:w-[400px] h-[354px] z-40 fixed bottom-[40px] right-[40px] flex flex-col justify-between items-center p-6 gap-[24px] sm:gap-[44px]"
    ...
    <div class="flex-none w-[90%] sm:w-[352px] h-auto gap-[16px] flex flex-col items-center">
      <img src="/assets/images/avatar.png" class="w-[90%] h-[90%] sm:w-[104px] sm:h-[104px] text-center flex-none" />
    ...
    <button class="rounded-lg border-2 border-l-[#FE592A] border-b-[#FE592A] border-r-[#E93013] border-t-[#E93013] 
              shadow-md bg-gradient-to-r from-[#FE592A] to-[#E93013] text-white 
              hover:bg-gradient-to-r hover:from-white hover:border-2 hover:border-orange-500 hover:text-orange-500 
              h-[90%] sm:h-[50px] w-full sm:w-[352px] px-4 sm:px-6 py-3 flex-auto"
