<template>
  ...
  >
    ...
    <button
      ...
      class="w-[352px] h-[45px] px-6 py-0 rounded-lg border-2 opacity-100 bg-gradient-to-r from-[#FE592A] bg-[#E93013] text-white border-l-2 border-b-2 border-r-[#E93013] border-t-[#E93013] shadow-md hover:bg-gradient-to-r hover:from-white hover:border-2 hover:border-orange-500 0 flex items-center justify-center"
    >
      <p
