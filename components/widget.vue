<template>
  <div class="">
    <div
      class="widget-container max-h-[100vh] max-w-[100vw] bg-white z-40 fixed widget-container rounded-lg flex flex-col overflow-hidden shadow-lg w-full sm:w-[400px] lg:w-[450px] xl:w-[400px] h-full sm:h-[668px] lg:h-[calc(540px)] xl:h-[668px] right-0 sm:right-[40px] lg:right-[60px] bottom-0 sm:bottom-[40px] lg:bottom-[60px]"
    ...
    >
      ...
      >
        <div
          class="bg-white rounded-lg p-4 w-[366px] sm:w-[368px] h-[231px] sm:h-[228px] m-4 flex flex-col gap-2"
        >
  ...
  >
    ...
    <button @click="modalStore.toggleWidget" class="z-40">
      <img
        ...
        class="w-[64px] sm:w-[80px] h-[64px] sm:h-[80px]"
      />
    </button>
  </div>
  <div
  ...
  >
    ...
    <button
      ...
      class="w-full sm:w-[352px] h-[45px] px-6 py-0 rounded-lg border-2 opacity-100 bg-gradient-to-r from-[#FE592A] to-[#E93013] text-white border-l-2 border-b-2 border-r-[#E93013] border-t-[#E93013] shadow-md hover:bg-gradient-to-r hover:from-white hover:border-2 hover:border-orange-500 hover:text-orange-500 flex items-center justify-center"
    >
      <p
