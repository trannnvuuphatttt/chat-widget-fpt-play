<template>
  <div class="">
    <div
      ...
      <div v-show="modalStore.showModal"
        ...
        <div class="bg-white rounded-lg p-4 w-[368px] h-fit m-4 flex flex-col gap-2">
          ...
          <div class="flex flex-auto justify-between gap-2">
            ...
            <button class="flex-auto p-2 border-2 border-[#EFEFEF] text-gray-400 bg-[#EFEFEF] w-[120px] rounded-md"
  ...
  <div
    ...
    <div class="flex-none w-[352px] h-[149px] gap-[24px] flex flex-col items-center">
      <img src="/assets/images/avatar.png" class="w-[104px] h-[104px] text-center flex-none" />
    ...
    <button
      ...
      <p class="text-[16px] text-center font-sf-pro-display leading-[20.8px] tracking-custom font-medium  ">Bắt đầu trò
        chuyện</p>
    </button>
  </div>
</template>
