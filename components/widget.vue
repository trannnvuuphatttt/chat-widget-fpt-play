<template>
  <div class="">
    <div
      class="widget-container max-h-[100vh] max-w-[100vw] bg-white z-40 fixed widget-container rounded-lg flex flex-col overflow-hidden shadow-lg w-full lg:w-[400px] h-full lg:h-[668px] right-0 lg:right-[60px] bottom-0 lg:bottom-[60px]"
  ...
  <div
    ...
    <button class="relative self-end -mt-2 -mr-2 flex-none" @click="modalStore.toggleWidget">
