<template>
  ...
  <div
    ...
    v-html="marked.parse(props.message)"
    class="md:text-base break-words max-w-full bg-white rounded-tl rounded-r-2xl rounded-b-2xl text-md mb-2 p-4 text-base font-sf-pro-display w-[338px] sm:w-[420px] md:w-[480px] lg:w-[338px] xl:w-[338px]"
  />
</template>
